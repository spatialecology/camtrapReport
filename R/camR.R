...
.report_css_block <- function() {
  paste0(
    ...
    "/* Keep headings and title area clean */\n",
    ".main-container h1,\n",
    ".main-container h2,\n",
    ".main-container h3,\n",
    ".main-container h4,\n",
    ...
    "/* Hyperlinks: always blue, no underline */\n",
    "a,\n",
    "a:link,\n",
    "a:visited,\n",
    "a:hover,\n",
    ...
    "/* R Markdown / Bootstrap tab links */\n",
    ".nav a,\n",
    ".nav a:link,\n",
    ".nav a:visited,\n",
    ".nav a:hover,\n",
    ...
    ".tabset .nav-tabs > li.active > a:link,\n",
    ...
    "/* Tables should not be justified */\n",
    "table,\n",
    ".table,\n",
    ".dataTables_wrapper,\n",
    "th,\n",
    ...
    "  var blueLinks = document.querySelectorAll('a, .nav a, .nav-tabs a, .nav-pills a, .tabset .nav-tabs a, .tocify-item a, .list-group-item');\n",
    "  blueLinks.forEach(function(el) {\n",
    "    el.style.setProperty('color', '#007bff', 'important');\n",
    "    el.style.setProperty('text-decoration', 'none', 'important');\n",
    "  });\n",
    "  var activeToc = document.querySelectorAll('.list-group-item.active');\n",
    "  activeToc.forEach(function(el) {\n",
