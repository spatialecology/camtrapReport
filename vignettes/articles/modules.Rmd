...
description: "This vignette explains how users can manage modules, customise them, remove them from the report, change their order, and register and integrate new modules into the ecological report."
...
Figure 1 summarises how new modules are added to the report workflow. A module
is defined in a YAML file containing explanatory text, R code, or both. It is
then registered in the module library, added to the main `camReport` object,
tested separately, and included when generating the final Ecological Report.
