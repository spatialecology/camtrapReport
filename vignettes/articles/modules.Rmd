...
list_Modules(validate = TRUE)

# Move a module within the report hierarchy
move_Module("species_table", after = "captures", parent = "results")

# Move a module and its children to the module trash
remove_Module("species_table", recursive = TRUE)

# Inspect active and deleted modules
list_Modules(include_trash = TRUE)

# Restore a removed module
restore_Module("species_table", test = TRUE)
```
