...
The following workshops and training activities have been held so far to introduce `camtrapReport` and demonstrate its main functionality. Public workshop pages or materials are not currently available, so these entries document the completed events rather than linking to unpublished resources. Links will be added when public materials become available.
