...
The function also invisibly returns the path to the HTML report. By default, `data_status.html` and its intermediate `data_status.Rmd` file are written beside the input dataset. Use `filename` to give another file stem or an existing output path:
