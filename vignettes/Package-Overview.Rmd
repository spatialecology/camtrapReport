...
- **Activity, diversity, abundance, and density analyses:** [activity](https://doi.org/10.32614/CRAN.package.activity), [overlap](https://doi.org/10.32614/CRAN.package.overlap), [iNEXT](https://doi.org/10.32614/CRAN.package.iNEXT), [camtrapDensity](https://github.com/MarcusRowcliffe/camtrapDensity), [Distance](https://CRAN.R-project.org/package=Distance), and [ct](https://doi.org/10.32614/CRAN.package.ct); and
- **Hierarchical and spatial modelling:** [unmarked](https://doi.org/10.32614/CRAN.package.unmarked) and [secr](https://CRAN.R-project.org/package=secr) package.
