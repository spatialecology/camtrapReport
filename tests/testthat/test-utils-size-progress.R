...
test_that("size estimation reads a regular file", {
  test_file <- tempfile(
...
test_that("size estimation sums files in a directory", {
  test_dir <- tempfile(
...
test_that("size estimation handles an empty directory", {
  test_dir <- tempfile(
...
test_that("size estimation reads compressed and uncompressed ZIP sizes", {
  test_dir <- tempfile(
...
test_that("camdata start message reports small datasets", {
  size_info <- list(
    file_size = 1024,
...
test_that("camdata start message reports compressed ZIP size", {
  size_info <- list(
    file_size = 1024,
    file_size_label = "1 KB",
...
test_that("camdata start message covers all size classes", {
  cases <- list(
